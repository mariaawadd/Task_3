...
export default function AllPerks() {
  ...
  // Effect #2: Auto-search on Input Change (searchQuery or merchantFilter)
  useEffect(() => {
  ...
  }, [searchQuery, merchantFilter]); // Re-runs on input change

  // Extract unique merchant names whenever perks change
  useEffect(() => {
